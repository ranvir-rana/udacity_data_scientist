...
def load_data(messages_filepath, categories_filepath):
    """
    Loads and merges the datasets from 2 filepaths.
    ...
    Returns:
    df: dataframe with merged messages and categories dataframe
...
def clean_data(df):
    ...
    # replace value - 2 with 1 in related column
...
def save_data(df, database_filename):
    """Stores the dataframe df in a SQLite database."""
